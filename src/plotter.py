...
def plot_3D(input, output, label):
	...
	surf = ax.bar3d(input['eta'],input['phi'],input['pT'],0.02,0.02,0.02,color='g',shade=False)
	...
	surf2 = ax.bar3d(output['eta'],output['phi'],output['pT'],0.02,0.02,0.02,shade=False)
