...
find_library(RECURSIVE_LIBRARY NAMES RecursiveTools
             HINTS $ENV{FASTJET_ROOT_DIR}/lib ${FASTJET_ROOT_DIR}/lib)
		
find_library(NSUBJETTINESS_LIBRARY NAMES Nsubjettiness
             HINTS $ENV{FASTJET_ROOT_DIR}/lib ${FASTJET_ROOT_DIR}/lib)
...
set(FASTJET_LIBRARIES ${FASTJET_LIBRARY} ${RECURSIVE_LIBRARY} ${FASTJET_TOOLS_LIBRARY} ${NSUBJETTINESS_LIBRARY})
